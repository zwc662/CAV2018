...
module grid_world
	...
	[] (s= 199) = true -> 0.111111111111 : (s'=182) + 0.222222222222 : (s'=183) + 0.25 : (s'=198) + 0.416666666667 : (s'=199);
	...
	[] (s= 235) = true -> 0.169811320755 : (s'=234) + 0.801886792453 : (s'=250) + 0.0283018867925 : (s'=251);
	[] (s= 236) = true -> 0.815384615385 : (s'=251) + 0.184615384615 : (s'=267);
	...
	[] (s= 245) = true -> 0.0378787878788 : (s'=228) + 0.85606060606 : (s'=229) + 0.106060606061 : (s'=245);
	...
	[] (s= 250) = true -> 0.383333333333 : (s'=249) + 0.0833333333333 : (s'=250) + 0.216666666667 : (s'=265) + 0.316666666667 : (s'=266);
	[] (s= 251) = true -> 0.141340782123 : (s'=250) + 0.837430167598 : (s'=266) + 0.0212290502793 : (s'=267);
	...
	[] (s= 262) = true -> 0.166666666667 : (s'=246) + 0.833333333333 : (s'=262);
	...
	[] (s= 283) = true -> 0.157142857143 : (s'=282) + 0.714285714286 : (s'=298) + 0.128571428571 : (s'=299);
