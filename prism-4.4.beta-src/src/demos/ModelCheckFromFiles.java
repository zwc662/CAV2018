...
public class ModelCheckFromFiles
{
	...
	public void run()
	{
		try {
			...
			ModulesFile modulesFile = prism.parseModelFile(new File("/Users/weichaozhou/Documents/Safe_AI_MDP/prism-4.3.1-src/src/demos/dice.pm")); 
			prism.loadPRISMModel(modulesFile);
			// Parse and load a properties model for the model
			PropertiesFile propertiesFile = prism.parsePropertiesFile(modulesFile, new File("/Users/weichaozhou/Documents/Safe_AI_MDP/prism-4.3.1-src/src/demos/dice.pctl"));
			System.out.println(propertiesFile.getProperty(0));
			...
			propertiesFile = prism.parsePropertiesString(modulesFile, prop2);
			result = prism.modelCheck(propertiesFile, propertiesFile.getPropertyObject(0));
			System.out.println(result.getResult());
