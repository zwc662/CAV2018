...
public class MDPAdversaryGeneration
{
	...
	public void run()
	{
		try {
			...
			ModulesFile modulesFile = prism.parseModelFile(new File("/Users/weichaozhou/Documents/Safe_AI_MDP/prism-api/examples/robot.prism"));
			...
			PropertiesFile propertiesFile = prism.parsePropertiesFile(modulesFile, new File("/Users/weichaozhou/Documents/Safe_AI_MDP/prism-api/examples/robot.props"));
